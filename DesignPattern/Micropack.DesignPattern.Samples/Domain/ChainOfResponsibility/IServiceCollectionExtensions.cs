...
namespace Micropack.DesignPattern.Samples.ChainOfResponsibility
{
    ...
    {
        public static IChainConfigurator<TContext> Chain<TContext>(this IServiceCollection services) where TContext : class
        {
            return new ChainConfiguratorImplate<TContext>(services);
        }
    }
}

namespace ChainConfigurator
{
    ...
    public class ChainConfiguratorImplate<TChain> : IChainConfigurator<TChain> where TChain : class
    {
        private List<Type> _types;
        private Type _interfaceType;
        private readonly IServiceCollection _services;

        public ChainConfiguratorImplate(IServiceCollection services)
        {
            _services = services;
